# NebulumMarsRovers Golang SDK Reference

Complete API reference for the NebulumMarsRovers Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *NebulumMarsRoversSDK`
...
#### `Photo(data map[string]any) NebulumMarsRoversEntity`
