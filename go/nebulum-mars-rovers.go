...
// instead of `sdk.NewNebulumMarsRoversSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NebulumMarsRoversSDK  { return NewNebulumMarsRoversSDK(nil) }
func Test() *NebulumMarsRoversSDK { return TestSDK(nil, nil) }
