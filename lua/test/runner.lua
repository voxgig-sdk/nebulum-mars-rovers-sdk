...
function runner.env_override(m)
  local live = runner.getenv("NEBULUM_MARS_ROVERS_TEST_LIVE")
  local override = runner.getenv("NEBULUM_MARS_ROVERS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NEBULUM_MARS_ROVERS_TEST_EXPLAIN")
