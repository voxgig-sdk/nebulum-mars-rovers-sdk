...
function runner.env_override(m)
  local live = runner.getenv("NEBULUMMARSROVERS_TEST_LIVE")
  local override = runner.getenv("NEBULUMMARSROVERS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NEBULUMMARSROVERS_TEST_EXPLAIN")
