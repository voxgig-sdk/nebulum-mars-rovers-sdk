...
AQL-driven CLI and REPL for the NebulumMarsRovers SDK. Positional arguments are
...
```sh
go build -o nebulum-mars-rovers-cli ./...
```
...
./nebulum-mars-rovers-cli load 1 photo
./nebulum-mars-rovers-cli load '{id:1}' photo
