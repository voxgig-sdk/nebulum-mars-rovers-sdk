...
func registerSDKWords(r *eng.Registry, client *sdk.NebulumMarsRoversSDK) {
...
func runOp(client *sdk.NebulumMarsRoversSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
