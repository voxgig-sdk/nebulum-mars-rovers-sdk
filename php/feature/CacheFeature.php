...
// NebulumMarsRovers SDK cache feature
...
class NebulumMarsRoversCacheFeature extends NebulumMarsRoversBaseFeature
{
    ...
    private function _through(NebulumMarsRoversContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
