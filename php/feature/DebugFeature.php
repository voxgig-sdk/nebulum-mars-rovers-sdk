...
// NebulumMarsRovers SDK debug feature
...
class NebulumMarsRoversDebugFeature extends NebulumMarsRoversBaseFeature
{
    ...
    private function _finish(NebulumMarsRoversContext $ctx, bool $ok): void
    {
