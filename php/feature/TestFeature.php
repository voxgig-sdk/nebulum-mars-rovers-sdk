...
// NebulumMarsRovers SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NebulumMarsRoversTestFeature extends NebulumMarsRoversBaseFeature
{
    ...
    public function init(NebulumMarsRoversContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NebulumMarsRoversContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NebulumMarsRoversParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NebulumMarsRoversContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NebulumMarsRoversContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = NebulumMarsRoversParam::call($ctx, $k);
