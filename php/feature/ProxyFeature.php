...
// NebulumMarsRovers SDK proxy feature
...
class NebulumMarsRoversProxyFeature extends NebulumMarsRoversBaseFeature
{
    ...
    public function init(NebulumMarsRoversContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NebulumMarsRoversContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
