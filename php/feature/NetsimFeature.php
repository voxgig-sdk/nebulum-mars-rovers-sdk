...
// NebulumMarsRovers SDK netsim feature
...
class NebulumMarsRoversNetsimFeature extends NebulumMarsRoversBaseFeature
{
    ...
    private function _simulate(NebulumMarsRoversContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NebulumMarsRoversContext $ctx, array $applied): void
    {
        $client = $this->client;
