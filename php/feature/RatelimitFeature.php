...
// NebulumMarsRovers SDK ratelimit feature
...
class NebulumMarsRoversRatelimitFeature extends NebulumMarsRoversBaseFeature
{
    ...
    private function _acquire(NebulumMarsRoversContext $ctx): void
    {
    ...
    private function _track(NebulumMarsRoversContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
