...
// NebulumMarsRovers SDK utility: result_basic

class NebulumMarsRoversResultBasic
{
    public static function call(NebulumMarsRoversContext $ctx): ?NebulumMarsRoversResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof NebulumMarsRoversError) ? $result->err->msg : (string)$result->err;
