...
// NebulumMarsRovers SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NebulumMarsRoversTransformResponse
{
    public static function call(NebulumMarsRoversContext $ctx): mixed
    {
        ...
        $transform = NebulumMarsRoversHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
