...
// NebulumMarsRovers SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NebulumMarsRoversSDK::test)
...
{
    private const SDK_CLASS = 'NebulumMarsRoversSDK';
    ...
    private const SDK_BASE = 'nebulummarsrovers_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nebulummarsrovers_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
