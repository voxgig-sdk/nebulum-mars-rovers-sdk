...
// NebulumMarsRovers SDK pipeline test
//
...
{
    private static function utility(): NebulumMarsRoversUtility
    {
        return new NebulumMarsRoversUtility();
    }
    ...
    private static function ctx(array $over = []): NebulumMarsRoversContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NebulumMarsRoversContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NebulumMarsRoversOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NebulumMarsRoversError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NebulumMarsRoversOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NebulumMarsRoversMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NebulumMarsRoversOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NebulumMarsRoversMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NebulumMarsRoversOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NebulumMarsRoversMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NebulumMarsRoversSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NebulumMarsRoversMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NebulumMarsRoversResponse([]),
            'result' => new NebulumMarsRoversResult([]),
        ]);
        [, $err] = NebulumMarsRoversMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NebulumMarsRoversSpec([]),
            'response' => null,
            'result' => new NebulumMarsRoversResult([]),
        ]);
        [, $err] = NebulumMarsRoversMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NebulumMarsRoversSpec(['step' => 's']),
            'response' => new NebulumMarsRoversResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NebulumMarsRoversResult([]),
        ]);
        [, $err] = NebulumMarsRoversMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NebulumMarsRoversSpec(['step' => 's']),
            'response' => new NebulumMarsRoversResponse(self::resp(200, ['v' => 1])),
            'result' => new NebulumMarsRoversResult([]),
        ]);
        [, $err] = NebulumMarsRoversMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NebulumMarsRoversSpec(['step' => 's']),
            'response' => new NebulumMarsRoversResponse(self::resp(200, ['v' => 2])),
            'result' => new NebulumMarsRoversResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NebulumMarsRoversMakeResponse::call($ctx);
    ...
    {
        $preset = new NebulumMarsRoversResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NebulumMarsRoversSpec([]),
            'response' => new NebulumMarsRoversResponse([]),
            'result' => new NebulumMarsRoversResult([]),
        ...
        [$got, $err] = NebulumMarsRoversMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NebulumMarsRoversResult([])]);
        [, $err] = NebulumMarsRoversMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NebulumMarsRoversSpec([]), 'result' => null]);
        [, $err] = NebulumMarsRoversMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NebulumMarsRoversSpec(['step' => 's']),
            'result' => new NebulumMarsRoversResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NebulumMarsRoversOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NebulumMarsRoversMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NebulumMarsRoversSpec(['step' => 's']),
            'result' => new NebulumMarsRoversResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NebulumMarsRoversOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NebulumMarsRoversMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NebulumMarsRoversResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NebulumMarsRoversSpec([]),
            'result' => new NebulumMarsRoversResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NebulumMarsRoversMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NebulumMarsRoversMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NebulumMarsRoversError('boom', 'boom');
        $utility->fetcher = function (NebulumMarsRoversContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NebulumMarsRoversSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NebulumMarsRoversMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NebulumMarsRoversContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NebulumMarsRoversMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NebulumMarsRoversResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NebulumMarsRoversMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NebulumMarsRoversContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NebulumMarsRoversSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NebulumMarsRoversMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NebulumMarsRoversResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NebulumMarsRoversSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NebulumMarsRoversMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NebulumMarsRoversMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NebulumMarsRoversMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NebulumMarsRoversResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NebulumMarsRoversDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NebulumMarsRoversResult(['ok' => false])]);
        $this->expectException(NebulumMarsRoversError::class);
        NebulumMarsRoversDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NebulumMarsRoversResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NebulumMarsRoversMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NebulumMarsRoversMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NebulumMarsRoversBaseFeature();
        $b = new NebulumMarsRoversBaseFeature();
        NebulumMarsRoversFeatureAdd::call($ctx, $a);
        NebulumMarsRoversFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NebulumMarsRoversBaseFeature
    {
        $f = new NebulumMarsRoversBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NebulumMarsRoversFeatureAdd::call($ctx, self::named_feature('a'));
        NebulumMarsRoversFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        NebulumMarsRoversFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        NebulumMarsRoversFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        NebulumMarsRoversFeatureAdd::call($ctx, $replace);
        ...
        NebulumMarsRoversFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NebulumMarsRoversContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NebulumMarsRoversSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NebulumMarsRoversPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NebulumMarsRoversPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NebulumMarsRoversResponse(['headers' => null]),
            'result' => new NebulumMarsRoversResult([]),
        ]);
        NebulumMarsRoversResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NebulumMarsRoversResultBody::call($ctx);
