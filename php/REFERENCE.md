# NebulumMarsRovers PHP SDK Reference

Complete API reference for the NebulumMarsRovers PHP SDK.
...
```php
require_once __DIR__ . '/nebulum-mars-rovers_sdk.php';
...
#### `NebulumMarsRoversSDK::test($testopts = null, $sdkopts = null)`
