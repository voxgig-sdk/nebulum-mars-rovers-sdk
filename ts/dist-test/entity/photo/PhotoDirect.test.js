...
(0, node_test_1.describe)('PhotoDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('NEBULUM_MARS_ROVERS_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NebulumMarsRoversSDK({
...
function liveScenariosActive() { return false && process.env.NEBULUM_MARS_ROVERS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NebulumMarsRoversSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NEBULUM_MARS_ROVERS_TEST_PHOTO_ENTID'];
    ...
    const client = new __1.NebulumMarsRoversSDK({
        base: 'http://localhost:8080',
