...
(0, node_test_1.describe)('PhotoEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.NebulumMarsRoversSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set NEBULUM_MARS_ROVERS_TEST_PHOTO_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.NebulumMarsRoversSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['NEBULUM_MARS_ROVERS_TEST_PHOTO_ENTID'];
    ...
    if (live) {
        client = new __1.NebulumMarsRoversSDK(merge([
