# NebulumMarsRovers Ruby SDK



The Ruby SDK for the NebulumMarsRovers API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `NebulumMarsRoversError` (a `StandardError` subclass), so wrap
...
```
rb/
├── NebulumMarsRovers_sdk.rb       -- Main SDK module
...
The main module (`NebulumMarsRovers_sdk`) exports the SDK class
