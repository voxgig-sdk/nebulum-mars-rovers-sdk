...
#      offline in seeded test mode (NebulumMarsRoversSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NebulumMarsRovers_sdk.rb")
  SDK_CLASS = "NebulumMarsRoversSDK"
  ...
  SDK_BASE = "NebulumMarsRovers_sdk"
