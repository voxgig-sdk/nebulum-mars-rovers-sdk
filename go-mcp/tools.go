...
type Args struct {
	Entity string         `json:"entity" jsonschema:"photo"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NebulumMarsRoversSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nebulum-mars-rovers_list",
		Description: "List records from NebulumMarsRovers. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nebulum-mars-rovers_load",
		Description: "Load a single record from NebulumMarsRovers. " +
...
func runOp(client *sdk.NebulumMarsRoversSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NebulumMarsRoversSDK, name string) (sdk.NebulumMarsRoversEntity, error) {
