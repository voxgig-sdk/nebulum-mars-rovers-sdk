// Command NebulumMarsRovers-mcp is an MCP server exposing the NebulumMarsRovers
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NebulumMarsRovers_list  — list records of an entity
//	NebulumMarsRovers_load  — load a single record of an entity
//
