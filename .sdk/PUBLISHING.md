...
|---|---|---|
| `ts/` | @voxgig-sdk/nebulum-mars-rovers-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nebulum-mars-rovers-sdk \
      --repository voxgig-sdk/nebulum-mars-rovers-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nebulum-mars-rovers-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nebulum-mars-rovers-sdk --id=<id>` removes it.
