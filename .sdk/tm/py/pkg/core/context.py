...
from projectname_sdk.core.control import NebulumMarsRoversControl
...
class NebulumMarsRoversContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = NebulumMarsRoversControl()
        ...
        if isinstance(sp, NebulumMarsRoversSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NebulumMarsRoversResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NebulumMarsRoversResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return NebulumMarsRoversOperation({})
    ...
    def make_error(self, code, msg):
        return NebulumMarsRoversError(code, msg, self)
