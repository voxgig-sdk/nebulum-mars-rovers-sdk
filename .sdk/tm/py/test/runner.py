...
class NebulumMarsRoversTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NebulumMarsRoversTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NebulumMarsRoversTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NebulumMarsRoversTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
