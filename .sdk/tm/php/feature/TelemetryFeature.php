...
// NebulumMarsRovers SDK telemetry feature
...
class NebulumMarsRoversTelemetryFeature extends NebulumMarsRoversBaseFeature
{
    ...
    private function _close(NebulumMarsRoversContext $ctx, bool $ok): void
    {
