...
// NebulumMarsRovers SDK clienttrack feature
...
class NebulumMarsRoversClienttrackFeature extends NebulumMarsRoversBaseFeature
{
    ...
    public function PostConstruct(NebulumMarsRoversContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NebulumMarsRovers-SDK';
