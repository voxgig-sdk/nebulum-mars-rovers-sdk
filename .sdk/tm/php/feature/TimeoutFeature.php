...
// NebulumMarsRovers SDK timeout feature
...
class NebulumMarsRoversTimeoutFeature extends NebulumMarsRoversBaseFeature
{
    ...
    private function _with_timeout(NebulumMarsRoversContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NebulumMarsRoversContext $_ctx, float $ms): void
    {
        $client = $this->client;
