...
// NebulumMarsRovers SDK rbac feature
...
class NebulumMarsRoversRbacFeature extends NebulumMarsRoversBaseFeature
{
    ...
    private function _required(NebulumMarsRoversContext $ctx): ?string
    {
    ...
    private function _reject(NebulumMarsRoversContext $ctx, string $required): void
    {
    ...
    private function _track(NebulumMarsRoversContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
