...
// NebulumMarsRovers SDK audit feature
...
class NebulumMarsRoversAuditFeature extends NebulumMarsRoversBaseFeature
{
    ...
    private function _emit(NebulumMarsRoversContext $ctx, string $outcome): void
    {
