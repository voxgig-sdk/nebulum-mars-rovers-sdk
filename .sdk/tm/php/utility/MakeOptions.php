...
// NebulumMarsRovers SDK utility: make_options

class NebulumMarsRoversMakeOptions
{
    ...
    public static function call(NebulumMarsRoversContext $ctx): array
    {
        ...
        //
        // `NebulumMarsRoversSchema::optspec()` is built from the model:
        ...
        $optspec = NebulumMarsRoversSchema::optspec();
