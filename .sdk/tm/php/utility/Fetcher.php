...
// NebulumMarsRovers SDK utility: fetcher

class NebulumMarsRoversFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NebulumMarsRoversSDK/1.0)';
    ...
    public static function call(NebulumMarsRoversContext $ctx, string $fullurl, array $fetchdef): array
    {
