...
// NebulumMarsRovers SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NebulumMarsRoversMakeRequest
{
    public static function call(NebulumMarsRoversContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NebulumMarsRoversResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NebulumMarsRoversResponse($fetched);
        } else {
