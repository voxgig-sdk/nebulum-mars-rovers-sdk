...
// NebulumMarsRovers SDK utility: graphql
//
...
class NebulumMarsRoversGraphql
{
    ...
    // equivalent.
    public static function body(NebulumMarsRoversContext $ctx): mixed
    {
    ...
    public static function errors(NebulumMarsRoversContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
