...
// NebulumMarsRovers SDK utility type

class NebulumMarsRoversUtility
{
    ...
    public static function copy(NebulumMarsRoversUtility $src): NebulumMarsRoversUtility
    {
        $u = new NebulumMarsRoversUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
