# NebulumMarsRovers SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NebulumMarsRoversSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NebulumMarsRoversSDK(...) and NebulumMarsRoversSDK.test(...) become
#      NebulumMarsRoversSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nebulummarsrovers_sdk"
_SDK_CLASS = "NebulumMarsRoversSDK"
