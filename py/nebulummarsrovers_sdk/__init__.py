...
from nebulummarsrovers_sdk.utility import register

# Load features
from nebulummarsrovers_sdk.feature.base_feature import NebulumMarsRoversBaseFeature
from nebulummarsrovers_sdk.features import _has_feature, _make_feature
...
class NebulumMarsRoversSDK:
    ...
    def get_utility(self):
        return NebulumMarsRoversUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NebulumMarsRoversSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Photo(self, data=None) -> "PhotoEntity":
        ...
        from nebulummarsrovers_sdk.entity.photo_entity import PhotoEntity
