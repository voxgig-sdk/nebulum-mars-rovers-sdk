# NebulumMarsRovers Python SDK Reference

Complete API reference for the NebulumMarsRovers Python SDK.
...
#### `NebulumMarsRoversSDK.test(testopts=None, sdkopts=None)`
...
| --- | --- | --- | --- |
| `camera` | `dict` | No |  |
| `earth_date` | `str` | No | Earth date when the photo was taken |
| `id` | `int` | No | Unique identifier for the photo |
| `img_src` | `str` | No | URL to the image file |
| `rover` | `dict` | No |  |
